...
import "../components/Style/basketball.scss";

class SelectedMatchBasketball extends Component {
 ...
 animateElement = (element,refName) => {
  ...
  render() {
          ...
          durationTeams =
            <div className="row team-list-big">
              <div className="col-lg-4 col-md-4">
                <Link to={`/currentmatchbasketball/${this.props.match.params.id}/${this.props.currentMatch.detail.homeTeam.teamGuid}`}>
              ...
              <div className="col-lg-4 col-md-4">
                <Link to={`/currentmatchbasketball/${this.props.match.params.id}/${this.props.currentMatch.detail.guestTeam.teamGuid}`}>
            ...
            var classFieldLink = i ===0  ? "fieldLink1" : "fieldLink2";
              return (
                <div key={i} className={classNameCurrent}>
                  <Link to={`/currentmatchbasketball/${this.props.match.params.id}/${item.teamGuid}`} className={classFieldLink}>
    ...
    <div>
      ...
      <div className="row">
          <div className="col-lg-12 col-md-12">
              <div className="field-basketball">
                  {durationPlayers}                
              </div>
            </div>
      </div>
...
export default connect(mapStateToProps,mapDispatchToProps)(LayoutHOC(SelectedMatchBasketball));